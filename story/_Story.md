...
Readable prose chapters will appear inside each arc's `chapters/` directory as they are written.

At the moment, the arc-level rewrite documents are ahead of the prose chapter production.
