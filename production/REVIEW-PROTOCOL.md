...
status: live
canon: false
aliases: [Hostile Review Protocol, Review Protocol]
tags: [project, review, critique]
---
# Review Protocol

Aggressive criticism is useful only when it attacks the strongest current version of the work.

The useful question is:

> **Can the reviewer identify a failure we did not already knowingly choose, and would fixing it make the eventual story better?**

## Review the artifact that actually exists

`story/` is reader-facing.

`production/` is writer-facing planning.

Do not treat production notes as dialogue, a symbolism ledger as reader exposition, a resource model as an onscreen HUD, or an unwritten scene as demonstrated bad execution.

Planning is not storytelling.

## Classification

Classify criticism as:

- **demonstrated flaw** — current material actually contradicts itself or fails
